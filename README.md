...
Full schema documentation: [docs/config/](docs/config/readme.md)
...
Full command reference: [docs/platform/commands.md](docs/platform/commands.md)
...
Full guide: [docs/platform/workflow.md](docs/platform/workflow.md)
...
For linting, type checking, and the full nox pipeline, see [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md#developer-setup).
...
Contributions are welcome! See [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) for workflow guidelines and developer setup (linting, testing, nox, lockfiles).

---

## Security

See [docs/SECURITY.md](docs/SECURITY.md) for the vulnerability reporting policy.
...
See [docs/SUPPORT.md](docs/SUPPORT.md) for where to get help and expected response times.
