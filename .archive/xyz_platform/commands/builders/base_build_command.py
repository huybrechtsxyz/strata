...
"""
===============================================================================
Script Name   : base_build_command.py
Author        : XYZ Platform Team
Version       : 1.0.0
Python Version: 3.12+
Description   : Base class for build commands.
===============================================================================
"""
...
class BaseBuildCommand(BaseCommand):
    ...
    def _before_execute(self) -> bool:
        """Load and validate deployment + configuration for builders."""
