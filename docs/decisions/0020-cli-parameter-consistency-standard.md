...
- Status: partially-implemented — standard established and adopted for new commands; retroactive migration of existing commands is incremental per Phase 4, not 100% complete
- Date: 2026-07-11
...
- Retroactive migration of existing commands to the standard (Phase 4) is incremental,
  not complete — other commands beyond `strata new` may still have undiscovered drift
  and should be spot-checked individually.
