...
from xyz_platform.cli import _build_default_map, _load_workspace_defaults, main
...
class TestDefaultMapIntegration:
    def test_workspace_default_applied_to_subcommand(self, tmp_path):
        ...
        with patch("xyz_platform.commands.config.set_config_command.SetConfigCommand.execute", return_value=True):
