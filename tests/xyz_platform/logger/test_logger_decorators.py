"""Tests for xyz_platform.logger.decorators — @log_performance and @trace_operation."""
...
from xyz_platform.logger.decorators import log_performance, trace_operation
