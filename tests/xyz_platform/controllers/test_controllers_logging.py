...
from xyz_platform.controllers.logging_controller import VALID_LEVELS, LoggingController
...
class TestLoggingControllerWrite:
    def test_write_creates_directory_and_file(self, tmp_path):
        ...
        assert ok is True
        assert (tmp_path / ".platform" / "logging.yaml").exists()
...
class TestLoggingControllerSetValue:
    ...
    def test_set_value_level_updates_both_paths(self, tmp_path):
        ...
        _, v2 = ctrl.get_value("loggers.xyz_platform.level")
        assert v1 == "DEBUG"
        assert v2 == "DEBUG"
...
class TestLoggingControllerUnsetValue:
    ...
    def test_unset_level_removes_both_paths(self, tmp_path):
        ...
        found2, _ = ctrl.get_value("loggers.xyz_platform.level")
