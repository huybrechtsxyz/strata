...
class TestConfigurationLoader:
    ...
    def test_load_single_file(self, tmp_path):
        ...
        # Load file
        config = loader.load_yaml_file(str(config_file))
    ...
    def test_load_invalid_yaml(self, tmp_path):
        ...
        with pytest.raises(yaml.YAMLError):
            loader.load_yaml_file(str(config_file))
    ...
    def test_load_nonexistent_file(self):
        ...
        with pytest.raises(FileNotFoundError):
            loader.load_yaml_file("/nonexistent/path/config.yaml")
    ...
    def test_load_yaml_file_not_a_file(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="Path is not a file"):
            loader.load_yaml_file(str(directory))
...
class TestConfigurationMerging:
    ...
    def test_merge_nested_dicts(self):
        ...
        config1 = {
            "spec": {"configuration": {"option1": "value1", "option2": "value2"}}
        }
        config2 = {
            "spec": {"configuration": {"option2": "override", "option3": "value3"}}
        }
...
class TestLoadAndMergeYamlFiles:
    ...
    def test_load_and_merge_yaml_files(self, tmp_path):
        ...
        # Load and merge
        result = loader.load_and_merge_yaml_files([str(config1), str(config2)])
    ...
    def test_load_and_merge_single_file(self, tmp_path):
        ...
        result = loader.load_and_merge_yaml_files([str(config_file)])
    ...
    def test_load_and_merge_with_nested_overrides(self, tmp_path):
        ...
        expected = {
            "spec": {"option1": "value1", "option2": "override", "option3": "value3"}
        }
        assert result == expected
