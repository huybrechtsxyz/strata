...
CONFIGURATION_FOLDER = os.path.join(
    os.path.dirname(__file__), "..", "..", "data", "configurations"
)
...
"""
        ...
        assert phase.scripts[0].name == "validate-before.ps1"
...
"""
        ...
        assert phase.scripts[0].name == "validate-before.ps1"
        assert phase.scripts[1].name == "validate-after.ps1"
        assert phase.scripts[2].name == "mock_validate.sh"
...
"""
        ...
        assert isinstance(phase.scripts[0], Path)
        assert isinstance(phase.scripts[1], Path)
        assert phase.scripts[0].name == "validate-before.ps1"
        assert phase.scripts[1].name == "mock_validate.sh"
