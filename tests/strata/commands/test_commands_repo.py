...
from strata.commands.repo.add_repo_solution_command import (
...
class TestRepoAdd:
    ...
    def test_add_remote_https_basic(self, tmp_path):
        runner = CliRunner()
        with patch(
            "strata.commands.repo.add_repo_solution_command.AddRepoSolutionCommand.execute",
            return_value=True,
        ):
...
class TestRepoList:
    def test_list_basic(self, tmp_path):
        runner = CliRunner()
        with patch(
            "strata.commands.repo.list_repo_solution_command.ListRepoSolutionCommand.execute",
            return_value=True,
        ):
...
class TestRepoRemove:
    def test_remove_basic(self, tmp_path):
        runner = CliRunner()
        with patch(
            "strata.commands.repo.remove_repo_solution_command.RemoveRepoSolutionCommand.execute",
            return_value=True,
        ):
...
class TestRepoSync:
    def test_sync_basic(self, tmp_path):
        runner = CliRunner()
        with patch(
            "strata.commands.repo.sync_repo_solution_command.SyncRepoSolutionCommand.execute",
            return_value=True,
        ):
...
class TestRepoStatus:
    def test_status_basic(self, tmp_path):
        runner = CliRunner()
        with patch(
            "strata.commands.repo.status_repo_solution_command.StatusRepoSolutionCommand.execute",
            return_value=True,
        ):
