...
def _controller(tmp_path: Path, layering=("zone", "tenant", "environment")):
...
class TestCheck1ArtifactPathUniqueness:
    def test_no_overlap_different_layers(self, tmp_path):
        ...
        m1 = _make_manifest(tmp_path, "a", {"zone": "eu", "tenant": "acme", "environment": "prd"}, "ws.yaml")
        m2 = _make_manifest(tmp_path, "b", {"zone": "eu", "tenant": "beta", "environment": "prd"}, "ws.yaml")
    ...
    def test_overlap_same_layers_same_workspace(self, tmp_path):
        ...
        layers = {"zone": "eu", "tenant": "acme", "environment": "prd"}
    ...
    def test_three_manifests_two_overlap(self, tmp_path):
        ...
        layers_shared = {"zone": "eu", "tenant": "acme", "environment": "prd"}
        layers_unique = {"zone": "eu", "tenant": "beta", "environment": "prd"}
...
class TestCheck3NamespaceOverlap:
    ...
    def test_same_namespace_same_layer_no_warning(self, tmp_path):
        ...
        layers_a = {"zone": "eu", "tenant": "acme", "environment": "prd"}
        layers_b = {"zone": "us", "tenant": "acme", "environment": "prd"}  # same keys, diff values
