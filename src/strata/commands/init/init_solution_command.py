...
from strata.models.platform_template_model import PlatformTemplateModel
...
from strata.services.platform_template_service import load_workspace_template
...
class InitSolutionCommand(BaseCommand):
    ...
    def _apply_template(self, template: PlatformTemplateModel) -> bool:
        ...
        for profile_tpl in template.spec.profiles or []:
            ...
            if profile_tpl.refs:
                from strata.models.platform_template_model import PlatformTemplateRefModel as _RefModel
