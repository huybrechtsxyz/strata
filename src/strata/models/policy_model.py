...
class PolicyModel(PlatformBaseModel):
    ...
    type: str = Field(
        ...,
        description="Policy type: tenant_zone | required_tags | naming_pattern | resource_type_restrictions | script | cve_max_severity | cost_threshold | path_convention | checkov | opa",
    )
