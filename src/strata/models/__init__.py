...
# src/strata/models/provider_config_model.py
# src/strata/models/provider_model.py
# src/strata/models/provisioning_model.py
# src/strata/models/resource_model.py
# src/strata/models/store_model.py
# src/strata/models/topology_config_model.py
# src/strata/models/topology_model.py
