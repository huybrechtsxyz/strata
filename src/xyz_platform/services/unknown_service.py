...
from xyz_platform.models.common_models import PlatformKind, ArtifactKind
...
class UnknownService(BaseService):
    ...
    def get_service_by_kind(self):
        ...
        elif kind == ArtifactKind.PLATFORM_ARTIFACT:
            # from xyz_platform.services.platform_artifact_service import (
            #    PlatformArtifactService,
            # )

            # return PlatformArtifactService(self.path)
            return None
