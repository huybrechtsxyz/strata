#!/usr/bin/env python3
"""
Custom stdlib logging handlers.

LogstashHandler  — ships JSON logs over TCP to a Logstash input.
configure_azure_monitor — wires Azure Monitor OpenTelemetry into the
                          stdlib root logger (captures all structlog output).
"""
