...
"""
===============================================================================
Script Name   : integration_model.py
Author        : Vincent Huybrechts
Version       : 1.0.0
Python Version: 3.12+
Description   : Pydantic models for integration configuration validation.

Integrations define external tools and services the platform uses to
extend its capabilities. Examples: git, terraform, bitwarden, vault.
===============================================================================
"""
...
class IntegrationModel(BaseModel):
    ...
    def validate_capabilities(cls, v: Set[str]) -> Set[str]:
        ...
        from xyz_platform.integrations.capabilities import VALID_CAPABILITY_NAMES
