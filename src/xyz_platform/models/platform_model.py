...
"""
===============================================================================
Module Name   : platform_model.py
Author        : XYZ Platform Team
Version       : 1.0.0
Python Version: 3.12+
Description   : Pydantic models for platform build output structure.
                Defines the complete schema for the generated platform
                configuration (e.g. workspace.json) consumed by IaC tools.

                Uses hybrid approach: reuses input models where possible,
                separate flattened models for output-specific structures.
                Each Platform* model merges meta + spec from its input
                counterpart and exposes from_*_model() classmethods.
===============================================================================
"""
...
from xyz_platform.models.namespace_model import (
    NamespaceModel as InputNamespaceModel,
)
from xyz_platform.models.provider_model import (
    ProviderModel,
    ProviderPropertiesModel,
    ProviderReferencesModel,
)
from xyz_platform.models.resource_model import (
