...
"""
===============================================================================
Script Name   : unknown_model.py
Author        : Vincent Huybrechts
Version       : 1.0.0
Python Version: 3.12+
Description   : Generic model for unknown or unsupported resource types.
                Used when:
                - Parsing YAML that doesn't match known PlatformKind values
                - Forward compatibility with future resource types
                - Debugging malformed configurations
                Provides minimal validation to preserve structure.
===============================================================================
"""
