...
from xyz_platform.controllers.logging_controller import LoggingController


class LogConfigCommand(BaseCommand):
    """Read and write `.platform/logging.yaml` workspace logging settings.
    ...
    def execute(self) -> bool:
        try:
            ...
            error_msg = f"Failed to execute log config command: {e}"
