"""Command to add a configuration path to a profile in an XYZ Platform solution."""
...
from xyz_platform.models.solution_model import SolutionSpecProfileConfigModel
