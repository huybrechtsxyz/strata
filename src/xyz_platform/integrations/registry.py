...
Version       : 1.0.0
Python Version: 3.12+
Description   : Integration registry for managing external integration dependencies.

The registry tracks which integrations are loaded and available, validates
their availability, and provides capability-based queries.
===============================================================================
"""
